...
You can use cdk-nag on existing CloudFormation templates by using the [cloudformation-include](https://docs.aws.amazon.com/cdk/v2/guide/use-cfn-template.html#use-cfn-template-import) module.
