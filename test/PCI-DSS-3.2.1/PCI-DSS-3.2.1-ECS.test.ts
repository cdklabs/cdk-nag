...
describe('Amazon Elastic Container Service (Amazon ECS)', () => {
  test("PCI.DSS.321-ECSTaskDefinitionUserForHostMode: - Containers in ECS task definitions configured for host networking have 'privileged' set to true and a non-empty non-root 'user' - (Control ID: 7.2.1)", () => {
