...
describe('Amazon Elastic Compute Cloud (Amazon EC2)', () => {
  test('NIST.800.53.R4-EC2EBSInBackupPlan: - EBS volumes are part of AWS Backup plan(s) - (Control IDs: CP-9(b), CP-10, SI-12)', () => {
  ...
  test('nist80053r4EC2RestrictedCommonPorts: - EC2 instances restrict common ports - (Control IDs: AC-4, CM-2, SC-7, SC-7(3))', () => {
    ...
    Aspects.of(positive4).add(new NIST80053R4Checks());
  ...
  test('nist80053r4EC2CheckSSHR‎estricted: - Security Groups do not allow for unrestricted SSH traffic - (Control IDs: AC-4, SC-7, SC-7(3))', () => {
    ...
    Aspects.of(positive5).add(new NIST80053R4Checks());
