...
describe('AWS CloudTrail', () => {
  test('NIST.800.53.R4-CloudTrailCloudWatchLogsEnabled: CloudTrail trails have CloudWatch logs enabled', () => {
  ...
  test('NIST.800.53.R4-CloudTrailEncryptionEnabled: CloudTrail trails have encryption enabled', () => {
    const nonCompliant = new Stack();
    Aspects.of(nonCompliant).add(new NIST80053R4Checks());
