...
describe('Elastic Load Balancing', () => {
  ...
  test('nist80053ELBDeletionProtectionEnabled: - ALB, NLB, and GLBs have deletion protection enabled - (Control IDs: CM-2, CP-10)', () => {
  ...
  test('nist80053ELBListenersUseSSLOrHTTPSOnly: - CLBs are only listening for SSL and HTTPS traffic - (Control IDs: AC-17(2), SC-7, SC-8, SC-8(1), SC-23)', () => {
    const positive = new Stack();
    const positive2 = new Stack();
    Aspects.of(positive).add(new NIST80053Checks());
    Aspects.of(positive2).add(new NIST80053Checks());
  ...
  test('nist80053ELBCrossZoneBalancing: - CLBs are load balanced across AZs - (Control IDs: SC-5, CP-10)', () => {
    const positive = new Stack();
    Aspects.of(positive).add(new NIST80053Checks());
  ...
  test('nist80053ELBUseACMCerts: - CLBs use ACM certificates - (Control IDs: AC-17(2), SC-7, SC-8, SC-8(1), SC-13)', () => {
